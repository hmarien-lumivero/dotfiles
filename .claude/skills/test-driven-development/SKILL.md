...
```csharp
[Fact]
public void AddItem_EmptyCart_IncreasesCountToOne()
{
    // Arrange
    var cart = new ShoppingCart();
    var item = new CartItem("Apple", 1.99m, 1);
...
```python
def test_add_one_item_to_empty_cart_increases_total_to_one(self):
    # Arrange
    cart = ShoppingCart()
    item = CartItem("Apple", 1.99, 1)
